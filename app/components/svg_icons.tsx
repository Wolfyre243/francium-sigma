...
export function APIIcon({
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.2" stroke={hexColor} width={width} height={height}>
...
export function UploadIcon({
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke={hexColor} width={width} height={height}>
...
export function BlankDocumentIcon({
    width, height, hexColor
} : {
    width: number;
    height: number;
